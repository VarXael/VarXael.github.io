...
const DATA = [
  ...
  { id:'sasha', title:'Project Sasha', year:2025, cat:'PERSONAL', role:'Game Designer', img:'./assets/images/ProjectSasha.svg',
    blurb:'A top-down exploration game where scanning is the entire game. Knowledge is the resource, memory is the currency, and every mechanic asks what is worth remembering.',
    story:'The world does not exist until you scan it into memory. A Ghost Scan is volatile and free; a Full Scan is permanent and costs real memory. Every act of looking is an act of budgeting.' },
